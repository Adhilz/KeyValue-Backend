...
@router.post(
    ...
    dependencies=[Depends(role_checker(EmployeeRole.HR))],
)
async def create_employee(
    ...
    return await employee_service.create(db, body)
...
@router.post(
    "/{employee_id}/departments/{department_id}", status_code=status.HTTP_201_CREATED
)
